...
#print(conversation)
conversation.memory.chat_memory.add_user_message("The commnets are as follows:")
for review in reviews:
    conversation.memory.chat_memory.add_user_message(review)
#conversation.memory.chat_memory.add_user_message("How is the weather in Faridabad, India")
